namespace SYSTEM
	...
	namespace GRAPHICS
	{
		inline BOOL BEGIN_SCALEFORM_MOVIE_METHOD(int scaleform, const char* functionName) { return invoke<BOOL>(0xF6E48914C7A8694E, scaleform, functionName); } // 0xF6E48914C7A8694E 0x215ABBE8
		inline void _ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING(char* value) { invoke<Void>(0xBA7148484BD90365, value); } // 0xBA7148484BD90365 0x4DAAD55B
		inline void _ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(int value) { invoke<Void>(0xC3D0841A0CC546A6, value); } // 0xC3D0841A0CC546A6 0x716777CB
		inline void END_SCALEFORM_MOVIE_METHOD() { invoke<Void>(0xC6796A8FFA375E53); } // 0xC6796A8FFA375E53 0x02DBF2D7
	...
	{	
		...
		inline void _FORCE_SOCIAL_CLUB_UPDATE() { invoke<Void>(0xEB6891F03362FB12); } // 0xEB6891F03362FB12 INTERESTING
	...
	namespace NETWORK
	{
		...
		static Hash _NETWORK_HASH_FROM_PLAYER_HANDLE(Player player) { /*EP_Marker("vm_begin");*/ return invoke<Hash>(0xBC1D768F2F5D6C05, player); /*EP_Marker("vm_end");*/ } // 0xBC1D768F2F5D6C05
...
//		inline void NETWORK_HANDLE_FROM_PLAYER(Player player, int* networkHandle, int bufferSize) { invoke<Void>(0x388EB2B86C73B6B3, player, networkHandle, bufferSize); } // 0x388EB2B86C73B6B3 0xD3498917
	...
	namespace TEST
	{
		...
		static NativeVector3 GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(Entity entity, float offsetX, float offsetY, float offsetZ) { return invoke<NativeVector3>(0x1899F328B0E12848, entity, offsetX, offsetY, offsetZ); } // 0x1899F328B0E12848 0xABCF043A
		...
		typedef Vehicle(__fastcall* tCREATE_VEHICLE)(Hash model, NativeVector3 pos, float heading, BOOL networked, BOOL scriptCheck);
		static Vehicle CREATE_VEHICLE(Hash model, NativeVector3 pos, float heading, BOOL networked, BOOL scriptCheck) { static tCREATE_VEHICLE oCREATE_VEHICLE = (tCREATE_VEHICLE)(Memory::pattern("48 89 5C 24 ? 55 56 57 41 54 41 55 41 56 41 57 48 8B EC 48 83 EC 50 F3 0F 10 02").count(1).get(0).get<void>()); return oCREATE_VEHICLE(model, pos, heading, *g_GameVariables->is_session_started, false); }
	...
	namespace REEEEEEEEE
	{
		inline Nano::n_Vector3 GET_GAMEPLAY_CAM_ROT(int rotationOrder) { return invoke<Nano::n_Vector3>(0x837765A25378F0BB, rotationOrder); } // 0x837765A25378F0BB 0x13A010B5
		inline Nano::n_Vector3 GET_GAMEPLAY_CAM_COORD() { return invoke<Nano::n_Vector3>(0x14D6F5678D8F1B37); } // 0x14D6F5678D8F1B37 0x9388CF79
		inline Nano::n_Vector3 GET_ENTITY_COORDS(Entity entity, bool alive) { return invoke<Nano::n_Vector3>(0x3FEF770D40960D5A, entity, alive); } // 0x3FEF770D40960D5A 0x1647F1CB
	}
}
#pragma warning(pop)
